            ...
            <div class="card mt-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea id="shipping_address" class="form-control @error('shipping_address') is-invalid @enderror" name="shipping_address" required autocomplete="shipping_address" autofocus rows="4"></textarea>
