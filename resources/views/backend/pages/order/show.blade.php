  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      <div class="card-header">
        <strong>View Orders #IB{{ $order->id }}</strong>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6 border-right">
            <p><strong>Ordere Name : </strong>{{ $order->name }} </p>
            <p><strong>Ordere Phone No : </strong>{{ $order->phone_no }} </p>
            <p><strong>Ordere Email : </strong>{{ $order->email }} </p>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <img src="{{ asset ('images/products/'. $cart->product->image->first()->image) }}" width="50px" style="width:50px; border-radius: unset;">
                @endif
              </td>
        ...
        <form action="{{ route('admin.order.charge', $order->id) }}" method="post">
          ...
          <a href="{{ route('admin.order.invoice', $order->id) }}" target="_blank" class="ml-2 btn btn-info">Generate Invoice</a>
        </form>
